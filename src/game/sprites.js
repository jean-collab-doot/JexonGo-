...
export const SPRITE_DEFS = {
  ...
  'boss-space-shuttle': { path: '/assets/enemies/Boss/Space_Shuttle_STS/space-shuttle-center-right-24.webp', frames: 24, frameCols: 4, frameRows: 6 },
  'boss-space-shuttle-left': { path: '/assets/enemies/Boss/Space_Shuttle_STS/space-shuttle-center-left-24.webp', frames: 24, frameCols: 4, frameRows: 6 },
  // FX — death / hit
