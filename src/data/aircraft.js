export const AIRCRAFT = {
  f22: {
    ...
    ability: { icon: '◈', name: 'STEALTH', description: 'Missiles 25% faster · fire 20% faster', missileSpeed: 1.25, fireRate: 0.8 },
  },
  t6: {
    id: 't6', name: 'T-6 Texan II', xpCost: 0, starter: true,
    type: 'trainer',
    color: '#fbbf24',
    ability: { icon: '✈', name: 'TRAINER', description: 'Balanced standard aircraft' },
  },
  pc21: {
    id: 'pc21', name: 'Pilatus PC-21', xpCost: 800, starter: false,
    type: 'trainer',
    color: '#60a5fa',
    ability: { icon: '⚡', name: 'SPEED', description: '+10% movement speed', moveSpeed: 1.1 },
  },
  c130: {
    id: 'c130', name: 'C-130 Hercules', xpCost: 2000, starter: false,
    type: 'transport',
    color: '#6b7280',
    ability: { icon: '♥', name: 'EXTRA HEART', description: '+1 life every level', extraLives: 1 },
  },
  a10: {
    id: 'a10', name: 'A-10 Thunderbolt II', xpCost: 3800, starter: false,
    type: 'attack',
    color: '#78716c',
    ability: { icon: '✹', name: 'HEAVY GUN', description: '+50% weapon damage', damage: 1.5 },
  },
  f16: {
    id: 'f16', name: 'F-16 Fighting Falcon', xpCost: 6000, starter: false,
    type: 'fighter',
    color: '#64748b',
    ability: { icon: '➤', name: 'MISSILE SPEED', description: 'Missiles 18% faster', missileSpeed: 1.18 },
  },
  f18: {
    id: 'f18', name: 'F/A-18 Hornet', xpCost: 8800, starter: false,
    type: 'fighter',
    color: '#475569',
    ability: { icon: '✦', name: 'MACHINE GUN', description: 'Twin shots · fire 30% faster', bonusShots: 1, fireRate: 0.7 },
  },
  f35: {
  ...
  sr71: {
    ...
    ability: { icon: '♥', name: 'BLACKBIRD', description: '+1 heart · +30% speed · rapid laser ×2', extraLives: 1, moveSpeed: 1.3, missileSpeed: 1.35, fireRate: 0.55, weapon: 'xray', damage: 2 },
  },
  f117: {
    id: 'f117', name: 'F-117 Nighthawk', xpCost: 0, starter: false, secret: true,
    type: 'stealth', color: '#111827',
    ability: { icon: '★', name: 'SECRET NIGHTHAWK', description: '+1 heart · stealth laser · double damage', extraLives: 1, moveSpeed: 1.18, missileSpeed: 1.25, fireRate: 0.7, weapon: 'xray', damage: 2 },
  },
};
